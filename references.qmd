...
- Anselin, Luc. 2020. Local Spatial Autocorrelation. GeoDa.[Link](https://geodacenter.github.io/workbook/6a_local_auto/lab6a.html#fn1)
...
- Darmofal, David. 2006. Spatial Econometrics and Political Science.[Link](https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=8c16dd4a68aa1725518b4d6a9d02321fbc91ce4c)

- Darmofal, David. 2015. Spatial Analysis for the Social Sciences. Cambridge University Press.

- Eilers, Lea. 2019. Spatial Autocorrelation and the Spatial Durbin Model. Robust Workshop Lecture Slides. [Link](https://rural-urban.eu/sites/default/files/05_Spatial%20Autocorrelation%20and%20the%20Spatial%20Durbin%20Model_Eilers.pdf)
...
- Hurtado, Carlos. 2016. Stationary, Homoscedastic, and Cross-Sectional Spatial Models. Lecture Slides. [Link](http://www.econ.uiuc.edu/~hrtdmrt2/Teaching/SE_2016_19/L5/L5_SARAR.pdf)
...
- Geographically Weighted Regression
  - [https://www.publichealth.columbia.edu/research/population-health-methods/geographically-weighted-regression](https://www.publichealth.columbia.edu/research/population-health-methods/geographically-weighted-regression)
  
- Raster & Point Data
  - [https://rspatial.org/raster/analysis/8-pointpat.html](https://rspatial.org/raster/analysis/8-pointpat.html)
  
- Spatial Data Analysis and Visualization with R (cited as DGES)
  - [http://www.geo.hunter.cuny.edu/~ssun/R-Spatial/](http://www.geo.hunter.cuny.edu/~ssun/R-Spatial/)
...
- Spatial Simulation Examples
  ...
  - [https://rpubs.com/jguelat/autocorr](https://rpubs.com/jguelat/autocorr)
  
- Spatial Autocorrelation
  - [https://www.r-bloggers.com/2019/07/exploring-spatial-autocorrelation-in-r/](https://www.r-bloggers.com/2019/07/exploring-spatial-autocorrelation-in-r/)
  
- Spatial Weighting
  - [https://rpubs.com/erikaaldisa/spatialweights](https://rpubs.com/erikaaldisa/spatialweights)
